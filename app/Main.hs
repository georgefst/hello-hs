...
main :: IO ()
main = start do
    -- main gui elements: frame, panel, text control, and the notebook
            ...
            $ column
                ...
                [ tabs
                    ...
                    , tab "listbox"
                        ...
                        $ column
                            5
                            [ hstretch $ dynamic $ widget sc1
                            , floatLeft $ row 0 [widget sl1, widget sl2]
                            ]
                    , tab "slider"
                        . container p5
                        . margin 10
...
kindof obj className = do
    classInfo_ <- classInfoFindClass className
    if
        | objectIsNull classInfo_ -> logMessage $ "kindof " <> className <> ": no such class"
        | objectIsNull obj -> logMessage $ "kindof " <> className <> ": null object"
        | otherwise -> do
            haskind <- objectIsKindOf obj classInfo_
